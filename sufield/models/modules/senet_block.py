...
class SELayer(nn.Module):
    ...
    def __init__(self, channel, reduction=16, D=-1):
        ...
        self.fc = nn.Sequential(ME.MinkowskiLinear(channel, channel // reduction), ME.MinkowskiReLU(inplace=True),
...
class SEBasicBlock(BasicBlock):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None, conv_type=ConvType.HYPER_CUBE, reduction=16, D=-1):
...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None, conv_type=ConvType.HYPER_CUBE, D=3, reduction=16):
